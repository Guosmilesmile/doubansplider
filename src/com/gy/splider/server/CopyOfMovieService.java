...
public class CopyOfMovieService implements Runnable {
	...
	public CopyOfMovieService(String movieUrl, String paramtype, String paramId) {
		super();
	...
	public CopyOfMovieService(String movieUrl, int method, String paramtype,
			String paramId) {
		super();
		this.MovieUrl = movieUrl;
		this.method = method;
